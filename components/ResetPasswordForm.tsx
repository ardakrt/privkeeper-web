    ...
    >
      ...
      <div className="p-8">
        <div className="flex items-center justify-center mb-6">
          <div className="w-12 h-12 bg-zinc-100 dark:bg-white/5 border border-zinc-200 dark:border-white/10 rounded-xl flex items-center justify-center shadow-inner">
            <Lock className="w-6 h-6 text-zinc-900 dark:text-white" strokeWidth={1.5} />
          </div>
        </div>
        ...
        <p className="text-center text-sm text-zinc-500 dark:text-zinc-400 mb-8">
          Hesabınız için güçlü bir parola belirleyin.
        </p>
