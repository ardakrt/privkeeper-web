      ...
      <div className="rounded-2xl border border-white/10 dark:border-white/10 light:border-zinc-200 bg-white/5 dark:bg-white/5 light:bg-white p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="relative">
            <label className="block text-sm font-medium text-white dark:text-white light:text-zinc-900 mb-2">
            ...
            <input
              ...
              autoComplete="off"
              className="w-full px-4 py-3 rounded-xl bg-white/5 dark:bg-white/5 light:bg-zinc-50 border border-white/10 dark:border-white/10 light:border-zinc-300 text-white dark:text-white light:text-zinc-900 placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
            />

            {/* Autocomplete Suggestions */}
            {showSuggestions && filteredServices.length > 0 && (
              <div className="absolute z-10 w-full mt-2 rounded-xl bg-zinc-900/95 dark:bg-zinc-900/95 light:bg-white border border-white/10 dark:border-white/10 light:border-zinc-200 shadow-2xl backdrop-blur-sm overflow-hidden">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl bg-white/5 dark:bg-white/5 light:bg-zinc-50 border border-white/10 dark:border-white/10 light:border-zinc-300 text-white dark:text-white light:text-zinc-900 placeholder:text-zinc-500 font-mono focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
            />
            <p className="mt-2 text-xs text-zinc-500 dark:text-zinc-500 light:text-zinc-600">
          ...
          <details className="group">
            <summary className="cursor-pointer list-none text-sm font-medium text-zinc-400 dark:text-zinc-400 light:text-zinc-600 hover:text-white dark:hover:text-white light:hover:text-zinc-900 transition-colors">
            ...
            <div className="mt-4 space-y-4 pl-6">
              ...
              <div>
                ...
                <select
                  name="algorithm"
                  defaultValue="SHA1"
                  className="w-full px-4 py-3 rounded-xl bg-white/5 dark:bg-white/5 light:bg-zinc-50 border border-white/10 dark:border-white/10 light:border-zinc-300 text-white dark:text-white light:text-zinc-900 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-white/5 dark:bg-white/5 light:bg-zinc-50 border border-white/10 dark:border-white/10 light:border-zinc-300 text-white dark:text-white light:text-zinc-900 placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all resize-none"
                />
              </div>
            </div>
          </details>
        ...
        <div className="mt-6 p-4 rounded-xl bg-blue-500/10 border border-blue-500/20">
          <p className="text-xs text-blue-400 dark:text-blue-400 light:text-blue-600">
